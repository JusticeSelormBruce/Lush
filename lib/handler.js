...
handler.index = function (data, callback) {
  ...
  if (data.method == "get") {
    ...
    helper.getTemplate('index',data, function(err,str){
...
handler.favicon  = function(data,callback){
   //reject any method that isn't get
   if (data.method == "get") {
    helper.readStaticFile("favicon", function(err,data){
      if(!err && data){
...
handler.public = function(data, callback){
   //reject any method that isn't get
   if (data.method == "get") {
    var trimmedPath =  data.path.replace("public/",'');

    helper.readStaticFile(trimmedPath,function(err ,data){
      if(!err && data){
        ...
        if(trimmedPath.indexOf(".js")> -1){
          contentType= "js"
        }
        if(trimmedPath.indexOf(".ico")> -1){
          contentType= "favicon"
        }
